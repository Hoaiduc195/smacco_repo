...
/**
 * Concrete LLM client for Groq Chat Completions API.
 * Uses Groq API directly.
 */
@Injectable()
export class GroqLlmClientService implements ILlmClient {
  private readonly logger = new Logger(GroqLlmClientService.name);
